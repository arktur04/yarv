...
class NodeTypeA(NodeType):
  def __init__(self, x, y, col, row):
    ...
    text(a1_txt, x, y + 12)
    Arrow(x, y + 20, x + 100, y + 20, 2, "a2", self.red_color)
    textAlign(LEFT, BOTTOM)
...
!rst_n"""
    ...
    #textAlign(LEFT, BOTTOM)
    #text(wb_a2_txt, x + 20, y + 42)  
    Arrow(x - 270, y + 10, x - 170, y + 10, 2, "op1_addr{0}".format(row), self.red_color)
    Arrow(x - 270, y + 30, x - 170, y + 30, 2, "op2_addr{0}".format(row), self.red_color)
#-----------------------------------------------------------------
